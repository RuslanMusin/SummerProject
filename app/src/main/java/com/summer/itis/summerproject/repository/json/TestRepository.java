...
public class TestRepository {
    ...
    private final String FIELD_AUTHOR_ID = "authorId";
    private final String FIELD_AUTHOR_NAME = "authorName";
    private final String FIELD_WIKI_URL = "wikiUrl";
    ...
    public Map<String, Object> toMap(Test test) {
        ...
        result.put(FIELD_AUTHOR_ID, test.getAuthorId());
        result.put(FIELD_AUTHOR_NAME, test.getAuthorName());
